...
import { discardWorkImage } from "@/lib/works";
import { respondWithWorkResult } from "../../works/respond";

// #72: free a confirmed work photo that never made it onto a work — the
// owner closed the form after uploading. A photo a work still names is left
// alone; the quota would otherwise keep charging for an orphan set.
